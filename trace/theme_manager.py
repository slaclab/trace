...
from qtpy.QtWidgets import QApplication, QPushButton, QStyleFactory
...
class ThemeManager(QObject):
    ...
    def __init__(self, app: QApplication, parent: QObject | None = None, light_stylesheet_path: str | None = None, dark_stylesheet_path: str | None = None
) -> None:
        """
